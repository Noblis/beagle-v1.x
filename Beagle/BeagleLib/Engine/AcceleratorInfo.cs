...
public class AcceleratorInfo<TFitFunc> : IDisposable where TFitFunc : struct, IFitFunc
{
    ...
    public Action<AcceleratorStream, KernelConfig, byte, uint, ArrayView<int>, ArrayView<Command>, uint, ArrayView<float>, uint, ArrayView<float>, float, ArrayView<int>, TFitFunc> Kernel { get; set; } = null!;
    #endregion
}